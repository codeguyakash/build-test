  ...
  return (
    <>
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-2 notch1"></div>
          <div className="col-2 notch1_1"></div>
          <div className="col-2 notch2"></div>
          <div className="col-2 notch2_1"></div>
          <div className="col-2 notch3"></div>
          <div className="col-2 notch3_1"></div>
          {/* <div className="col-2 notch2a"></div> */}
          {/* <div className="col-2 notch2b"></div> */}
        </div>
        <div className="row bodymain">
          <p>
            ...
            email us with details if you can help. There is a set of mock
            ...
            Donate Bitcoin: 16UQLq1HZ3CNwhvgrarV6pMoA2CDjb4tyF NodeJS Python
            Interface GTK Lipsum Rails .NET Groovy The standard Lorem Ipsum
